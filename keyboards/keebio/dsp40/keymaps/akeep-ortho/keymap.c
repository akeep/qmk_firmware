...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |-------------------------------------------------------------------------------------------|
     * | LCtrl |  LAlt | LCmd |   Spr | Raise | Space | Space | Lower | Left |   Up | Down | Right |
     * `-------------------------------------------------------------------------------------------'
     */
    [_QWERTY] = LAYOUT_ortho_4x12(
        ...
        KC_LCTL, KC_LOPT, KC_LGUI, MO(_ADJUST), MO(_LOWER), KC_SPC, KC_SPC, MO(_RAISE), KC_LEFT, KC_UP,  KC_DOWN, KC_RGHT
    ),
    ...
    [_LOWER] = LAYOUT_ortho_4x12(
        ...
        KC_LCTL, KC_LOPT, KC_LGUI, MO(_ADJUST), _______,  KC_SPC,   KC_SPC, _______, KC_LEFT, KC_UP,   KC_DOWN, KC_RGHT
    ),
     ...
     * |------------------------------------------------------------------------------------------|
     * | LCtrl |  LAlt |  LCmd |   Spr |       | Space | Space |       | Left | Down | Up | Right |
     * `------------------------------------------------------------------------------------------'
     */
