...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT(
        ...
        KC_LCTL, KC_LGUI, KC_LOPT, LT(_LOWER, KC_SPC), LT(_RAISE, KC_SPC), LT(_ADJUST, KC_ROPT), KC_RGUI, KC_RCTL
    ),
     ...
     * |  ~  | !  |  @  |  #  |  $  |  %  |  ^  |  &  |  *  |  (  |  )  |  BS   |
     * |------------------------------------------------------------------------|
     * | F1   | F2 | F3  | F4  | F5  | F5  |  F6  |  _ |  +  | {  | }  | Pipe   |
     * |------------------------------------------------------------------------|
     * | F7     | F8 | F9 | F10 | F11 | F12 | PIPE |  ±  |  : |   UP  |   ?     |
     * |------------------------------------------------------------------------|
     * |       |   |     |            |             |   LEFT   | DOWN | RIGHT   |
     * `------------------------------------------------------------------------'
     */
    [_LOWER] = LAYOUT(
        ...
        KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,S(KC_NUHS),KC_DQUO, KC_COLN, KC_UP, KC_QUES,
     ...
     */
     [_RAISE] = LAYOUT(
        ...
        KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_NUHS, KC_QUOT, KC_SCLN, _______, KC_SLSH,
